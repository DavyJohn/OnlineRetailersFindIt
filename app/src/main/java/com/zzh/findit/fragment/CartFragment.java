...
public class CartFragment extends BaseFragment {
    ...
    public CartFragment instance;
    @BindView(R.id.cart_tool)
    Toolbar mBar;
    @BindView(R.id.cart_web)
    WebView mWebView;
    @BindView(R.id.cart_loading)
    LoadingView mLoadView;
    @OnClick(R.id.cart_edit) void edit(){
        mWebView.loadUrl("javascript:editClick()");
    }
    @OnClick(R.id.cart_message) void message(){
        getWebUrl("cart-app");
    }
    ...
    private void getWebUrl(String type){
